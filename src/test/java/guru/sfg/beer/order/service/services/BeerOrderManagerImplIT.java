...
public class BeerOrderManagerImplIT {
    ...
    @Test
    public void testFullAllocationFailed() throws JsonProcessingException {
        BeerDto beerDto = BeerDto.builder().id(beerId).upc("12345").build();
        ...
        AllocationFailureEvent allocationFailureEvent = (AllocationFailureEvent)jmsTemplate.receiveAndConvert(JmsConfiguration.ALLOCATION_FAILURE_QUEUE);
    ...
    public void testPartialAllocation() throws JsonProcessingException {
        ...
        BeerOrder beerOrder = createBeerOrder();
        beerOrder.setCustomerRef("allocation-pending");
        BeerOrder savedBeerOrder = beerOrderManager.newBeerOrder(beerOrder);
